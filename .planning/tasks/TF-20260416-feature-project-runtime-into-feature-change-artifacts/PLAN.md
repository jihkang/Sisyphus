...
1. Align the task branch to the current local artifact-model baseline so projection builds on the same artifact foundation and slot/claim vocabulary.
2. Add a dedicated projection module that maps feature-task runtime state into artifact views.
