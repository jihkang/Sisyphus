...
1. Align the replay task to the current artifact-model baseline so slot bindings and claims build on top of the same durable record vocabulary.
2. Add or confirm a dedicated schema/model layer for slot and claim records.
