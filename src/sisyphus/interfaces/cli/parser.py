...
def build_parser() -> argparse.ArgumentParser:
    ...
    review_record_parser.add_argument("--reviewer", required=True)
    review_record_parser.add_argument("--verdict", choices=("pass", "fail"), required=True)
    review_record_parser.add_argument("--report", dest="report_path", required=True)
    review_record_parser.add_argument("--head-sha", dest="reviewed_head_sha", required=True)
    review_record_parser.add_argument("--finding-count", type=int, default=0)
    review_record_parser.add_argument("--blocking-finding-count", type=int, default=0)
    review_record_parser.add_argument("--summary")
