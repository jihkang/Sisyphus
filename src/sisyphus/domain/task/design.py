...
def sync_design_from_content(task: dict, content: str) -> dict:
...
__all__ = [
    ...
    "normalize_design_assessment_status",
    "normalize_design_confidence",
    "normalize_design_mode",
    "normalize_layer_impact",
    "summarize_design_anchor",
    "sync_design_from_content",
]
