...
def evaluate_typed_feature_change_artifact(
    feature_change_artifact: CompositeArtifactRecord,
    *,
    slot_bindings: FeatureChangeSlotBindings,
    verification_claims: Sequence[VerificationClaimRecord],
    ...
    resolved_bindings = slot_bindings
    resolved_claims = tuple(verification_claims)
